...
Ext.ux.DateTimeField = Ext.extend(Ext.form.DateField, {
	...
	regexText : '格式为YYYY-MM-DD H:m:s ',
	initComponent : function() {
		Ext.ux.DateTimeField.superclass.initComponent.call(this);
		this.triggerConfig = {
    ...
    onResize : function(w, h) {
    	Ext.ux.DateTimeField.superclass.onResize.apply(this, arguments);
    },
    // private
    onDestroy : function() {
        Ext.destroy(this.triggers);
        Ext.ux.DateTimeField.superclass.onDestroy.call(this);
    },
